# ethash-kernels
For whatever reason, Zawawawa released his Ethash kernels as open source code. This repo is a verbaitm copy of that code with a simplistic build environment and [meowpowminer](https://github.com/gangnamtestnet/meowpowminer) as a target. Although the code for meowpowminer has yet to be released.
